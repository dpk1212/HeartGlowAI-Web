...
function setupEventListeners() {
    ...
    nextBtn.addEventListener('click', () => {
        ...
        try {
            ...
            // Preserve message configurator data from sessionStorage (and localStorage)
            // Get configurator data from all possible sources with fallbacks
            ...
            console.log('Message configurator data being passed to next page:');
