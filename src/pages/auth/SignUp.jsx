        ...
        >
          ...
          >
            ...
            <motion.div className="absolute inset-2 bg-white rounded-full flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="url(#gradient)" strokeWidth="2" className="w-10 h-10">
                <defs>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <motion.div variants={itemVariants}>
              <label htmlFor="name" className="block text-white/90 text-sm font-medium mb-1">Full Name</label>
            ...
            <motion.div variants={itemVariants}>
              <label htmlFor="password" className="block text-white/90 text-sm font-medium mb-1">Password</label>
              <div className="relative">
                <input
                  id="password"
            ...
            <motion.div variants={itemVariants}>
              <label htmlFor="confirmPassword" className="block text-white/90 text-sm font-medium mb-1">Confirm Password</label>
              <div className="relative">
                <input
                  id="confirmPassword"
                  type={showPassword ? "text" : "password"}
                  className={`w-full px-4 py-3 bg-white/30 text-white border rounded-lg focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent placeholder-white/50 ${!passwordMatch ? 'border-red-400' : 'border-white/30'}`}
                  ...
                  disabled={isLoading}
                />
                <svg className={`absolute right-3 top-1/2 transform -translate-y-1/2 h-5 w-5 ${!passwordMatch ? 'text-red-400' : 'text-white/50'}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <motion.div variants={itemVariants} className="mt-6 text-white/60 text-center text-xs">
            <p>By creating an account, you agree to our <br />
              <Link to="/terms" className="text-white underline">Terms of Service</Link> and <Link to="/privacy" className="text-white underline">Privacy Policy</Link>
            </p>
          </motion.div>
        </motion.div>
