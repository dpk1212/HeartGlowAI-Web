      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        <div className="w-full max-w-md backdrop-blur-md bg-white/10 rounded-2xl shadow-xl p-8 border border-white/20 relative z-10">
          ...
          >
            ...
            <p className="text-white/80">Sign in to continue to Heart Glow AI</p>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <Link to="/forgot-password" className="text-pink-300 text-xs hover:text-pink-200 transition-colors">
                  Forgot Password?
                </Link>
              </div>
              <div className="relative">
        ...
        >
          <p className="text-white/80">
            ...
            <Link to="/signup" className="text-pink-300 font-medium hover:text-pink-200 transition-colors">
              Sign Up Now
            </Link>
          </p>
        </motion.div>
