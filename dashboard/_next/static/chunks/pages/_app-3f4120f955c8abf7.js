 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vt(e){if(e.code!==tI.FAILED_PRECONDITION||"The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab."!==e.message)throw e;index_esm2017_N("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let si=class si{constructor(e,t){this.count=e,this.unchangedNames=t}};function ui(e){if(void 0===e)return index_esm2017_k("GRPC error has no .code"),tI.UNKNOWN;switch(e){case m.OK:return tI.OK;case m.CANCELLED:return tI.CANCELLED;case m.UNKNOWN:return tI.UNKNOWN;case m.DEADLINE_EXCEEDED:return tI.DEADLINE_EXCEEDED;case m.RESOURCE_EXHAUSTED:return tI.RESOURCE_EXHAUSTED;case m.INTERNAL:return tI.INTERNAL;case m.UNAVAILABLE:return tI.UNAVAILABLE;case m.UNAUTHENTICATED:return tI.UNAUTHENTICATED;case m.INVALID_ARGUMENT:return tI.INVALID_ARGUMENT;case m.NOT_FOUND:return tI.NOT_FOUND;case m.ALREADY_EXISTS:return tI.ALREADY_EXISTS;case m.PERMISSION_DENIED:return tI.PERMISSION_DENIED;case m.FAILED_PRECONDITION:return tI.FAILED_PRECONDITION;case m.ABORTED:return tI.ABORTED;case m.OUT_OF_RANGE:return tI.OUT_OF_RANGE;case m.UNIMPLEMENTED:return tI.UNIMPLEMENTED;case m.DATA_LOSS:return tI.DATA_LOSS;default:return index_esm2017_O()}}(g=m||(m={}))[g.OK=0]="OK",g[g.CANCELLED=1]="CANCELLED",g[g.UNKNOWN=2]="UNKNOWN",g[g.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",g[g.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",g[g.NOT_FOUND=5]="NOT_FOUND",g[g.ALREADY_EXISTS=6]="ALREADY_EXISTS",g[g.PERMISSION_DENIED=7]="PERMISSION_DENIED",g[g.UNAUTHENTICATED=16]="UNAUTHENTICATED",g[g.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",g[g.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",g[g.ABORTED=10]="ABORTED",g[g.OUT_OF_RANGE=11]="OUT_OF_RANGE",g[g.UNIMPLEMENTED=12]="UNIMPLEMENTED",g[g.INTERNAL=13]="INTERNAL",g[g.UNAVAILABLE=14]="UNAVAILABLE",g[g.DATA_LOSS=15]="DATA_LOSS";/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tL=null;function Cu(){return null===tL?tL=268435456+Math.round(2147483648*Math.random()):tL++,"0x"+tL.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tM={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tU="WebChannelConnection";let Mu=class Mu extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;let t=e.ssl?"https":"http";this.mo=t+"://"+e.host,this.yo="projects/"+this.databaseId.projectId+"/databases/"+this.databaseId.database+"/documents"}get po(){return!1}Io(e,t,l,u,h){let d=Cu(),f=this.To(e,t);index_esm2017_N("RestConnection",`Sending RPC '${e}' ${d}:`,f,l);let m={};return this.Eo(m,u,h),this.Ao(e,f,m,l).then(t=>(index_esm2017_N("RestConnection",`Received RPC '${e}' ${d}: `,t),t),t=>{throw index_esm2017_M("RestConnection",`RPC '${e}' ${d} failed with error: `,t,"url: ",f,"request:",l),t})}vo(e,t,l,u,h,d){return this.Io(e,t,l,u,h)}Eo(e,t,l){e["X-Goog-Api-Client"]="gl-js/ fire/"+tv,e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((t,l)=>e[l]=t),l&&l.headers.forEach((t,l)=>e[l]=t)}To(e,t){let l=tM[e];return`${this.mo}/v1/${t}:${l}`}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Ao(e,t,l,u){let h=Cu();return new Promise((d,f)=>{let m=new tp;m.setWithCredentials(!0),m.listenOnce(to.COMPLETE,()=>{try{switch(m.getLastErrorCode()){case ta.NO_ERROR:let t=m.getResponseJson();index_esm2017_N(tU,`XHR for RPC '${e}' ${h} received:`,JSON.stringify(t)),d(t);break;case ta.TIMEOUT:index_esm2017_N(tU,`RPC '${e}' ${h} timed out`),f(new index_esm2017_U(tI.DEADLINE_EXCEEDED,"Request time out"));break;case ta.HTTP_ERROR:let l=m.getStatus();if(index_esm2017_N(tU,`RPC '${e}' ${h} failed with status:`,l,"response text:",m.getResponseText()),l>0){let e=m.getResponseJson();Array.isArray(e)&&(e=e[0]);let t=null==e?void 0:e.error;if(t&&t.status&&t.message){let e=function(e){let t=e.toLowerCase().replace(/_/g,"-");return Object.values(tI).indexOf(t)>=0?t:tI.UNKNOWN}(t.status);f(new index_esm2017_U(e,t.message))}else f(new index_esm2017_U(tI.UNKNOWN,"Server responded with status "+m.getStatus()))}else f(new index_esm2017_U(tI.UNAVAILABLE,"Connection failed."));break;default:index_esm2017_O()}}finally{index_esm2017_N(tU,`RPC '${e}' ${h} completed.`)}});let g=JSON.stringify(u);index_esm2017_N(tU,`RPC '${e}' ${h} sending request:`,u),m.send(t,"POST",g,l,15)})}Ro(e,t,l){let u=Cu(),h=[this.mo,"/","google.firestore.v1.Firestore","/",e,"/channel"],d=te(),f=tr(),g={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},_=this.longPollingOptions.timeoutSeconds;void 0!==_&&(g.longPollingTimeout=Math.round(1e3*_)),this.useFetchStreams&&(g.xmlHttpFactory=new tf({})),this.Eo(g.initMessageHeaders,t,l),g.encodeInitMessageHeaders=!0;let b=h.join("");index_esm2017_N(tU,`Creating RPC '${e}' stream ${u}: ${b}`,g);let E=d.createWebChannel(b,g),k=!1,L=!1,V=new Nu({ro:t=>{L?index_esm2017_N(tU,`Not sending because RPC '${e}' stream ${u} is closed:`,t):(k||(index_esm2017_N(tU,`Opening RPC '${e}' stream ${u} transport.`),E.open(),k=!0),index_esm2017_N(tU,`RPC '${e}' stream ${u} sending:`,t),E.send(t))},oo:()=>E.close()}),w=(e,t,l)=>{e.listen(t,e=>{try{l(e)}catch(e){setTimeout(()=>{throw e},0)}})};return w(E,tm.EventType.OPEN,()=>{L||index_esm2017_N(tU,`RPC '${e}' stream ${u} transport opened.`)}),w(E,tm.EventType.CLOSE,()=>{L||(L=!0,index_esm2017_N(tU,`RPC '${e}' stream ${u} transport closed`),V.wo())}),w(E,tm.EventType.ERROR,t=>{L||(L=!0,index_esm2017_M(tU,`RPC '${e}' stream ${u} transport errored:`,t),V.wo(new index_esm2017_U(tI.UNAVAILABLE,"The operation could not be completed")))}),w(E,tm.EventType.MESSAGE,t=>{var l;if(!L){let h=t.data[0];h||index_esm2017_O();let d=h.error||(null===(l=h[0])||void 0===l?void 0:l.error);if(d){index_esm2017_N(tU,`RPC '${e}' stream ${u} received error:`,d);let t=d.status,l=function(e){let t=m[e];if(void 0!==t)return ui(t)}(t),h=d.message;void 0===l&&(l=tI.INTERNAL,h="Unknown error status: "+t+" with message "+d.message),L=!0,V.wo(new index_esm2017_U(l,h)),E.close()}else index_esm2017_N(tU,`RPC '${e}' stream ${u} received:`,h),V._o(h)}}),w(f,tc.STAT_EVENT,t=>{t.stat===td.PROXY?index_esm2017_N(tU,`RPC '${e}' stream ${u} detected buffering proxy`):t.stat===td.NOPROXY&&index_esm2017_N(tU,`RPC '${e}' stream ${u} detected no buffering proxy`)}),setTimeout(()=>{V.fo()},0),V}};function Ou(){return"undefined"!=typeof document?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ku=class Ku extends class{}{constructor(e,t,l,u){super(),this.authCredentials=e,this.appCheckCredentials=t,this.connection=l,this.serializer=u,this.lu=!1}fu(){if(this.lu)throw new index_esm2017_U(tI.FAILED_PRECONDITION,"The client has already been terminated.")}Io(e,t,l){return this.fu(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([u,h])=>this.connection.Io(e,t,l,u,h)).catch(e=>{throw"FirebaseError"===e.name?(e.code===tI.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),e):new index_esm2017_U(tI.UNKNOWN,e.toString())})}vo(e,t,l,u){return this.fu(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([h,d])=>this.connection.vo(e,t,l,h,d,u)).catch(e=>{throw"FirebaseError"===e.name?(e.code===tI.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),e):new index_esm2017_U(tI.UNKNOWN,e.toString())})}terminate(){this.lu=!0}};let Qu=class Qu{constructor(e,t){this.asyncQueue=e,this.onlineStateHandler=t,this.state="Unknown",this.wu=0,this._u=null,this.mu=!0}gu(){0===this.wu&&(this.yu("Unknown"),this._u=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this._u=null,this.pu("Backend didn't respond within 10 seconds."),this.yu("Offline"),Promise.resolve())))}Iu(e){"Online"===this.state?this.yu("Unknown"):(this.wu++,this.wu>=1&&(this.Tu(),this.pu(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.yu("Offline")))}set(e){this.Tu(),this.wu=0,"Online"===e&&(this.mu=!1),this.yu(e)}yu(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}pu(e){let t=`Could not reach Cloud Firestore backend. ${e}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nh(e,t,l){if(!l)throw new index_esm2017_U(tI.INVALID_ARGUMENT,`Function ${e}() cannot be called with an empty ${t}.`)}function ih(e){if(!ht.isDocumentKey(e))throw new index_esm2017_U(tI.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${e} has ${e.length}.`)}function rh(e){if(ht.isDocumentKey(e))throw new index_esm2017_U(tI.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${e} has ${e.length}.`)}function oh(e){if(void 0===e)return"undefined";if(null===e)return"null";if("string"==typeof e)return e.length>20&&(e=`${e.substring(0,20)}...`),JSON.stringify(e);if("number"==typeof e||"boolean"==typeof e)return""+e;if("object"==typeof e){if(e instanceof Array)return"an array";{var t;let l=(t=e).constructor?t.constructor.name:null;return l?`a custom ${l} object`:"an object"}}return"function"==typeof e?"a function":index_esm2017_O()}function uh(e,t){if("_delegate"in e&&(e=e._delegate),!(e instanceof t)){if(t.name===e.constructor.name)throw new index_esm2017_U(tI.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{let l=oh(e);throw new index_esm2017_U(tI.INVALID_ARGUMENT,`Expected type '${t.name}', but it was: ${l}`)}}return e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ah=class ah{constructor(e){var t,l;if(void 0===e.host){if(void 0!==e.ssl)throw new index_esm2017_U(tI.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host="firestore.googleapis.com",this.ssl=!0}else this.host=e.host,this.ssl=null===(t=e.ssl)||void 0===t||t;if(this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.cache=e.localCache,void 0===e.cacheSizeBytes)this.cacheSizeBytes=41943040;else{if(-1!==e.cacheSizeBytes&&e.cacheSizeBytes<1048576)throw new index_esm2017_U(tI.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}(function(e,t,l,u){if(!0===t&&!0===u)throw new index_esm2017_U(tI.INVALID_ARGUMENT,`${e} and ${l} cannot be used together.`)})("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:void 0===e.experimentalAutoDetectLongPolling?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=th(null!==(l=e.experimentalLongPollingOptions)&&void 0!==l?l:{}),function(e){if(void 0!==e.timeoutSeconds){if(isNaN(e.timeoutSeconds))throw new index_esm2017_U(tI.INVALID_ARGUMENT,`invalid long polling timeout: ${e.timeoutSeconds} (must not be NaN)`);if(e.timeoutSeconds<5)throw new index_esm2017_U(tI.INVALID_ARGUMENT,`invalid long polling timeout: ${e.timeoutSeconds} (minimum allowed value is 5)`);if(e.timeoutSeconds>30)throw new index_esm2017_U(tI.INVALID_ARGUMENT,`invalid long polling timeout: ${e.timeoutSeconds} (maximum allowed value is 30)`)}}(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}isEqual(e){var t,l;return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&(t=this.experimentalLongPollingOptions,l=e.experimentalLongPollingOptions,t.timeoutSeconds===l.timeoutSeconds)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}};let hh=class hh{constructor(e,t,l,u){this._authCredentials=e,this._appCheckCredentials=t,this._databaseId=l,this._app=u,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new ah({}),this._settingsFrozen=!1}get app(){if(!this._app)throw new index_esm2017_U(tI.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return void 0!==this._terminateTask}_setSettings(e){if(this._settingsFrozen)throw new index_esm2017_U(tI.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new ah(e),void 0!==e.credentials&&(this._authCredentials=function(e){if(!e)return new index_esm2017_Q;switch(e.type){case"firstParty":return new index_esm2017_H(e.sessionIndex||"0",e.iamToken||null,e.authTokenFactory||null);case"provider":return e.client;default:throw new index_esm2017_U(tI.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}}(e.credentials))}_getSettings(){return this._settings}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask||(this._terminateTask=this._terminate()),this._terminateTask}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(e){let t=tF.get(e);t&&(index_esm2017_N("ComponentProvider","Removing Datastore"),tF.delete(e),t.terminate())}(this),Promise.resolve()}};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Uh=class Uh{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Uh(Ve.fromBase64String(e))}catch(e){throw new index_esm2017_U(tI.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(e){return new Uh(Ve.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Kh=class Kh{constructor(...e){for(let t=0;t<e.length;++t)if(0===e[t].length)throw new index_esm2017_U(tI.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new at(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let jh=class jh{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new index_esm2017_U(tI.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new index_esm2017_U(tI.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return et(this._lat,e._lat)||et(this._long,e._long)}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
