    ...
    async function getPerplexityApiKey() {
      try {
        ...
        // Access the secrets collection directly - matching the exact structure from Firebase console
        ...
        console.error('Perplexity API key not found in secrets collection');
