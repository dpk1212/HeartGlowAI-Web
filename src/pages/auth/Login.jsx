        ...
        >
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-end">
              <Link to="/forgot-password" className="text-sm text-[#FFC1CC] hover:underline transition-all duration-200">
                Forgot Password?
              </Link>
            </div>
          </div>
          ...
          <motion.button
            type="submit"
            className="w-full bg-white text-[#B19CD9] font-bold py-3.5 px-4 rounded-lg shadow hover:bg-[#E6E0FA] focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-opacity-50 transition-all duration-200 uppercase tracking-wide"
