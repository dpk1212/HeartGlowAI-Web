 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tT=new pe(ht.comparator),tS=new pe(ht.comparator);function hs(...e){let t=tS;for(let l of e)t=t.insert(l.key,l);return t}function ls(e){let t=tS;return e.forEach((e,l)=>t=t.insert(e,l.overlayedDocument)),t}function ws(){return new os(e=>e.toString(),(e,t)=>e.isEqual(t))}let tA=new pe(ht.comparator),tC=new Ee(ht.comparator);function gs(...e){let t=tC;for(let l of e)t=t.add(l);return t}let tx=new Ee(et);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
